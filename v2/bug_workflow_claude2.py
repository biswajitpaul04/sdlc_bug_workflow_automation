...
Checks Jira for new bugs, marks them as In Progress, and generates code solutions
"""
        ...
        try:
            ...
            for idx, issue in enumerate(issues):
                try:
                    ...
                    logger.error(f"Issue data: {json.dumps(issue, indent=2, default=str)}")
                    continue
...
class ClaudeCodeGenerator:
    ...
    def _build_prompt(bug: Dict) -> str:
        ...
        return f"""You are a senior software engineer. A bug has been reported in our system:
